...
const ActivityItem = ({id, name, period, role, type, contribution, url}) => {
  ...
  return (
    <div className="w-full">
      <div className="activity-item flex-1 h-[394px]">
        ...
        <div className="activity-item-container h-[394px] flex rounded-[10px] rounded-tr-[0px] border-2 border-gray-line">
          <div className="left w-6/12 h-[416px] pl-[50px] py-[37px] text-left">
          ...
          <div className="center w-5/12 pl-[50px] py-[37px] text-left">
          ...
          <div className="activity-edit-button w-1/12 flex-1 pt-[24px] text-left">
            <div className="cursor-pointer text-[15px] text-navy-dark">편집</div>
          </div>
        </div>
      </div>
    </div>
