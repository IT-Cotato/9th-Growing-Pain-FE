...
const ActivityCategory = ({key, category, image, content, navLink}) => {
  ...
  return (
    <div onClick={() => nav(`${navLink}`)} className="activity-container cursor-pointer w-[231px] h-[304px] rounded-[10px] bg-navy-lightSide box-border shadow-[0px_2px_2px_rgba(0,0,0,0.1)]">
