...
const ActivityCategory = ({category, image, content, navLink}) => {
  ...
  return (
    <div onClick={() => nav(`${navLink}`)} className="activity-container cursor-pointer h-[300px] rounded-[10px] bg-navy-lightSide box-border shadow-[0px_2px_2px_rgba(0,0,0,0.1)]">
