...
const ApplicationStatus = ({ id, company, position, deadline, date }) => {
  ...
  // 디데이에 따른 css
    ...
    // 지원현황 컴포넌트 - 클릭하면 해당 공모의 상세 페이지로 이동
		<div onClick={()=>nav(`/user/growth/apply/${id}`)} className="apply-item-container cursor-pointer relative flex-col text-[17px] w-[31%] h-[130px] p-[18px] mb-[1%] bg-white border rounded-[10px] box-border shadow-[0px_2px_2px_rgba(0,0,0,0.1)]">
