const ApplicationStatus = ({ id, company, position, submitDocument, submitInterview, deadline }) => {
  ...
  // 디데이에 따른 css
	...
	return (
    // 지원현황 컴포넌트
		<div className="apply-item-container relative flex-col text-[17px] w-[312px] h-[239px] px-[39px] pt-[36px] pb-[35px] bg-white border rounded-[10px] box-border shadow-[0px_2px_2px_rgba(0,0,0,0.1)]">
      {/* 경계선 기준 위의 내용 - 회사명, 직무 */}
