...
// // 						? selectedSubCategory
// // 						: selectedCategory
// // 							? categoryOptions[selectedCategory] // 여기를 수정하여 '자유' 또는 '포트폴리오'만 표시되도록 함
// // 							: '카테고리'}
// // 					<FaAngleDown />
// // 				</button>
// // 			)}
...
// 					className="flex h-[42px] w-[202px] items-center justify-between bg-navy-mypageToggle rounded-[10px] text-[15px] px-5 text-[#606060]"
// 				>
// 					{category !== 'ALL' ? selectedSubCategory : selectedCategory ? categoryOptions[selectedCategory] : '카테고리'}{' '}
// 					<FaAngleDown />
// 				</button>
// 			)}
// 			{location.pathname === '/user/community/total' && isMenuOpen && (
			...
			>
				{location.pathname === '/user/community/total'
					? selectedSubCategory || selectedCategory
						? categoryOptions[selectedCategory] || selectedSubCategory
						: '카테고리'
					: selectedSubCategory || '카테고리'}
				<FaAngleDown />
			</button>
